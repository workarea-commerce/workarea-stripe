...
desc "Release version #{Workarea::Stripe::VERSION} of the gem"
task :release do
  ...
  system "gem push workarea-stripe-#{Workarea::Stripe::VERSION}.gem --host #{host}"
  system "rm workarea-stripe-#{Workarea::Stripe::VERSION}.gem"
end
